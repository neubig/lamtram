...
std::vector<dynet::Expression> EncoderDecoder::GetEncodedState(
  ...
  dynet::Expression i_decin = affine_transform({i_enc2dec_b_, i_enc2dec_W_, i_combined});
  // Perform transformation
...
template
std::vector<dynet::Expression> EncoderDecoder::GetEncodedState<Sentence>(
                  const Sentence & sent_src, bool train, dynet::ComputationGraph & cg);
template
std::vector<dynet::Expression> EncoderDecoder::GetEncodedState<vector<Sentence> >(
                  const vector<Sentence> & sent_src, bool train, dynet::ComputationGraph & cg);

dynet::Expression EncoderDecoder::BuildSentGraph(const Sentence & sent_src,
...
dynet::Expression EncoderDecoder::BuildSentGraph(const std::vector<Sentence> & sent_src,
...
dynet::Expression EncoderDecoder::SampleTrgSentences(const Sentence & sent_src,
                                                         const Sentence * sent_trg,   
                                                         int num_samples,
                                                         int max_len,
                                                         bool train,
