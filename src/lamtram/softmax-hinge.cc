...
dynet::Expression SoftmaxHinge::CalcLoss(dynet::Expression & in, dynet::Expression & prior, const Sentence & ngram, bool train) {
...
dynet::Expression SoftmaxHinge::CalcLoss(dynet::Expression & in, dynet::Expression & prior, const std::vector<Sentence> & ngrams, bool train) {
  Expression score = affine_transform({i_sm_b_, i_sm_W_, in});
  if(prior.pg != nullptr) score = score + prior;
...
dynet::Expression SoftmaxHinge::CalcProb(dynet::Expression & in, dynet::Expression & prior, const Sentence & ctxt, bool train) {
  THROW_ERROR("CalcProb not valid for hinge");
  return softmax(affine_transform({i_sm_b_, i_sm_W_, in}));
}
dynet::Expression SoftmaxHinge::CalcProb(dynet::Expression & in, dynet::Expression & prior, const vector<Sentence> & ctxt, bool train) {
  THROW_ERROR("CalcProb not valid for hinge");
  return softmax(affine_transform({i_sm_b_, i_sm_W_, in}));
}
dynet::Expression SoftmaxHinge::CalcLogProb(dynet::Expression & in, dynet::Expression & prior, const Sentence & ctxt, bool train) {
  return (prior.pg != nullptr ?
          affine_transform({i_sm_b_, i_sm_W_, in}) + prior :
          affine_transform({i_sm_b_, i_sm_W_, in}));
}
dynet::Expression SoftmaxHinge::CalcLogProb(dynet::Expression & in, dynet::Expression & prior, const vector<Sentence> & ctxt, bool train) {
  return (prior.pg != nullptr ?
          affine_transform({i_sm_b_, i_sm_W_, in}) + prior :
          affine_transform({i_sm_b_, i_sm_W_, in}));
}
